...
function Menu() {
  ...
  <>
    <motion.div className="flex flex-col font-inter bg-background max-w-screen h-screen w-full overflow-hidden gap-1 text-text">  {/* OPAKOWANIE CALEJ STRONY */}
      {/* MENU */}
      <motion.div className="group/item flex flex-none flex-row gap-7 bg-background px-4 py-2 justify-between rounded-xl items-center scrollbar-thumb-blue-300 scrollbar-gutter-stable"
      layout> 
        ...
        <div className='flex flex-row gap-8 h-fit'>
          <div className="flex flex-row gap-5 w-full">
              {/* <input list="media"  className=" px-4 py-2 rounded-lg select-none border-gray-300 bg-white" type="text" name="search" id="input" placeholder='Szukaj filmów...' /> */}
              <MenuOptionSearch />
              <MenuOptionProfile />
              <MenuOptionLogout />
          </div>
