...
function Menu() {
  ...
  <>
    ...
    <div className="flex flex-col max-h-screen justify-between">
      {/* SIDEBAR */}
      <motion.div className="flex flex-col gap-13 h-screen bg-blue-400 p-6 py-11 rounded-2xl w-90 top-6 overflow-y-auto justify-center"
      ...
      > 
        ...
        <div className='flex flex-col gap-8 '>
            ...
            <div className="flex flex-col gap-9">
              ...
              {/* TODO ZMIENIC IKONE  */}
              <MenuOption text={"Watched films"} url={user !== null ? `/watch-history` : `/login`} icon={<FavouriteIcon/>}/>
              <MenuOption text={"Favourite"} url={user !== null ? `/favourites` : `/login`} icon={<HeartIcon/>}/>
            </div>
          </div>
        <div className='flex flex-col gap-8'>
